...
public class ListAccessTokensResponse {
    private OptionalNullable<List<GetAccessTokenResponse>> data;
     ...
     * @return Returns the Internal List of GetAccessTokenResponse
     */
    @JsonGetter("data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<List<GetAccessTokenResponse>> internalGetData() {
        return this.data;
    }
