...
public class ListUsagesResponse {
    private OptionalNullable<List<GetUsageResponse>> data;
     ...
     */
    protected ListUsagesResponse(OptionalNullable<List<GetUsageResponse>> data,
     ...
     * The usage objects
     * @return Returns the Internal List of GetUsageResponse
     */
    @JsonGetter("data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<List<GetUsageResponse>> internalGetData() {
        return this.data;
    }
